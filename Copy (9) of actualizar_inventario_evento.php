...
if($consulta_inventario->Id_Inventario_Evento != ""){
    ...
    if($inventario_almacen->Cantidad_Inventario >= $cantidad_inventario){
        ...
        $nueva_cantidad_evento = $consulta_inventario->Cantidad + $cantidad_inventario;
        
        
        $qry_update = "update ds_tbl_inventario_evento set Cantidad = $nueva_cantidad_evento, Fecha_Registro = '{$fecha_acutal}' where Id_Inventario_Evento = $id_inventario_evento";
        //
        //echo $qry_update;
        ...
        echo "Solo puedes asignar m&aacute;ximo " . $inventario_almacen->Cantidad_Inventario;
    }
