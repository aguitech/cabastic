...
<?php 
$nombre_seccion = "Tipos productos";
$tbl_main = "ds_cat_tipo_producto";
$nombre_simple = "tipo producto";
$url_name = "tipos_producto.php";
$url_crear_name = "crear_tipo_producto.php";
?>
<?php 
				...
				<div class="card" id="container">
					...
					<table class="table datatable-basic">
						...
						<?php foreach($resultados as $resultado): ?>
							...
							$id_resultado=$resultado->Id_Tipo_Producto;
