	...
	<script>
		...
		function filtrar_resultados_tabla(){
			   ...
			   $.ajax({
					...
					//data: { limit:val_limit, offset:val_offset },
					data: { id_marca:id_marca, id_producto:id_producto, id_talla:id_talla, id_color:id_color, id_genero:id_genero, id_almacen:id_almacen, id_tipo_producto:id_tipo_producto },
					success:function(data){
						console.log(data);
					...
					<div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                            	...
                            	<select name="id_tipo_producto" id="id_tipo_producto" class="form-control" onchange="filtrar_tipo_producto(this.value)">
