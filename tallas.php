			...
			<div class="content">
				...
				<div class="card">
					...
					<table class="table datatable-basic">
						...
						<?php 
						$qry_tallas = "select * from ds_cat_talla";
						...
						//exit();
						?>
						<tr id="element<?php echo $talla->Id_Talla; ?>">
								<td><a href="usuarios_editar.php?id=<?php echo $talla->Id_Talla; ?>"><?php echo $talla->Id_Talla; ?></a></td>
								<td><?php echo $talla->Descripcion; ?></td>
								<td><?php if($talla->Activo == 1): echo "Activo"; else: echo "Inactivo"; endif; ?></td>
