...
<div id="">
	...
	<br />
	<br />
	<b style="font-size:18px; padding-left:40px;"><?php echo $resultado->Fecha_Venta; ?></b>
	<br />
	<b style="font-size:18px; padding-left:40px;">$ <?php echo $resultado->MontoTotal; ?> USD</b>
				...
				<button type="button" class="btn bg-teal-400 btn-labeled btn-labeled-left rounded-round" onclick="realizar_pago(<?php echo $id_resultado; ?>)"><b><i class="icon-reading"></i></b> Realizar pago</button>
