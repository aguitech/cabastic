...
<?php 
$nombre_seccion = "Tipos de gastos";
$tbl_main = "ds_cat_tipo_gasto";
$nombre_simple = "tipo de gasto";
$url_name = "tipos_gastos.php";
$url_crear_name = "crear_tipo_gasto.php";
?>
<?php 
if($_POST["Tipo_Gasto"] != ""){
    
    $val_descripcion = $_POST["Tipo_Gasto"];
    ...
    if($_POST["editar"] != ""){
        ...
        //echo $qry_edit;
        $qry_edit = "update ds_cat_tipo_gasto set Tipo_Gasto = '{$val_descripcion}' where Id_Tipo_Gasto = $id_editar";
        //
        $obj->query($qry_edit);
        
        
        header('Location: ./tipos_gastos.php', true, 303);
        exit;
    }else{
        ...
        $qry_insert = "insert into ds_cat_tipo_gasto (Tipo_Gasto) values ('{$val_descripcion}')";
					...
					<table class="table datatable-basic">
                        ...
                        ?>  
							...
							*/ ?>
							...
							<?php 
							$qry_resultados = "select * from $tbl_main order by Tipo_Gasto asc";
						...
						<?php foreach($resultados as $resultado): ?>
							...
							$id_resultado=$resultado->Id_Tipo_Gasto;
							?>
