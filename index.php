<?php
 ...
 $qt = "SELECT * FROM intranet_admin WHERE nombre='$usuario' AND pass='$password' LIMIT 1";
...
//echo "<h1>Usuario:".$usuario."   Nombre:".$nombre."        Password: ".$password."    Pass: ".$pass;


if($usuario==$nombre && $password==$pass && $usuario!="" && $password!=""){
	$_SESSION['login']  = "ok";
	...
	<div class="navbar navbar-expand-md navbar-dark">
		...
		<div class="d-md-none">
			<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar-mobile">
				<i class="icon-tree5" style="display: none;"></i>
			</button>
		</div>
		...
		<div class="collapse navbar-collapse" id="navbar-mobile">
			...
			<span class="navbar-text ml-md-3 mr-md-auto" style="display: none;">
					...
					<div class="card mb-0">
						<div class="card-body">
							<div class="text-center mb-3">
								...
								*/ ?>
								<img src="images/logo_cabastic.png" alt="" style="width:240px; background:#324148; padding:20px; border-radius:100% 100% 30px 30px;">
								<?php /**
			...
			<div class="navbar navbar-expand-lg navbar-light" style="display: none;">
				...
				<div class="navbar-collapse collapse" id="navbar-footer">
					<span class="navbar-text">
						&copy; 2020 - 2021. <a href="#">Limitless Web App Kit</a> by <a href="http://sdm-robotics.com/" target="_blank">SDM Robotics</a>
					</span>

					<ul class="navbar-nav ml-lg-auto">
						<li class="nav-item">
							<a href="https://kopyov.ticksy.com/" class="navbar-nav-link" target="_blank"><i class="icon-lifebuoy mr-2"></i> Support</a>
						</li>
