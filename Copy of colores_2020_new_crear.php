...
<body>
	...
	<script>
		...
		function cargar_crear(){
			...
			window.history.pushState("object or string", "Title", "/panel/notas.php?func=new");
		...
		function cerrar_cargar(){
            ...
            window.history.pushState("proyectos", "Title", "/panel/notas.php");
            $('#container').show();
		...
		window.onpopstate = function (event) {
			...
			if(window.location.pathname == "/panel/notas.php"){
				console.log("PROY");
				//$("#container_create").hide("");
				//$("#container").show("");
				
			}
			if(window.location.pathname == "/panel/notas.php?func=new"){
				console.log("CREAR");
				/*
				$("#container_create").show("");
				$("#container").hide("");
					...
					<div class="row clearfix">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div style="text-align:right;">
                            	<a class="btn btn-primary" href="/Producto/ResgitrarProductoCompleto" role="button">Agregar <?php echo $nombre_simple; ?></a>
                                <?php /**
