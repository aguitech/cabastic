...
//echo $id_usuario;
$qry_usuario = "select * from ds_tbl_empleado where Id_Empleado = $id_usuario";
$usuario = $obj->get_row($qry_usuario);
...
if($_GET["cron"] == "job"){
    ...
    // Email body content
    $mailContent = "<h3>Orden de compra</h3>";
    ...
    $mailContent .= " gener&oacute; orden de compra:<br />";
