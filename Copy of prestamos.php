					...
					<table class="table datatable-basic">
                        ...
                        ?>  
							...
							*/ ?>
							...
							$qry_resultados = "select *, ds_tbl_evento.Descripcion as evento from $tbl_main left join ds_tbl_cliente on ds_tbl_cliente.Id_Cliente = $tbl_main.Id_Cliente left join ds_tbl_evento on ds_tbl_prestamo.Id_Evento = ds_tbl_evento.Id_Evento";
