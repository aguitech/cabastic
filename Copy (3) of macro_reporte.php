					...
					*/ ?>
					...
					function filtrar_por(tipo_filtrado){
						if(tipo_filtrado == 1){
							...
							$(".filtrados_generales").fadeOut("Slow");
					...
					<div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select onchange="filtrar_por(this.value);" id="anio" class="form-control">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select onchange="filtrar_tipo_reporte(this.value);" id="anio" class="form-control">
    							<option value="">Selecciona</option>
