			...
			<div class="content">
				...
				<div class="card">
					...
					<table class="table datatable-basic">
						...
						<?php 
						$qry_productos = "select * from ds_tbl_producto";
						...
						//exit();
						?>
						<tr id="element<?php echo $producto->Id_Producto; ?>">
								<td><a href="usuarios_editar.php?id=<?php echo $talla->Id_Talla; ?>"><?php echo $talla->Id_Talla; ?></a></td>
								<td><?php echo $producto->Nombre; ?></td>
								<td><?php echo $producto->Descripcion; ?></td>
								<td><?php if($producto->Activo == 1): echo "Activo"; else: echo "Inactivo"; endif; ?></td>
