    ...
    <h3><?php if($_POST["id"] != ""): echo "Actualizar"; else: echo "Crear"; endif; ?> cuenta por pagar</h3>
            ...
            <div class="form-row">
            	...
            	<div class="form-group col-md-6">
             		...
             		<div class="subtitle_form">Comprobante de pago</div>
    				<input type="file" placeholder="Comprobante de Pago" name="Comprobante_Pago" id="Comprobante_Pago" value="<?php echo $resultado->Comprobante_Pago; ?>"  class="form-control" />
            	</div>
