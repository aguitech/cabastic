...
$excentar_iva = $_POST["excentar_iva"];
...
<div style="padding:25px;">
    ...
    */
    ...
    if($_POST["id_evento"] != ""){
        ...
        No se ha podido guardar la venta, selecciona un cliente.
        <?php 
        ...
        $total_sin_descuento = $monto_total;
        ...
        if($porcentaje != ""){
            ...
            $descuento_porcentaje_val = ($monto_total / 100) * $porcentaje;
            $monto_total = $monto_total - $descuento_porcentaje_val;
        }
        $descuento_mxn = $total_sin_descuento - $monto_total;
        
        if($excentar_iva == "true"){
            //echo "Verdad";
            $excentar_iva_val = 1;
            
            $subtotal_mxn = $monto_total;
            ...
            $monto_total = $monto_total * 1.16;
            //$total_sin_descuento = $total_sin_descuento * 1.16;
        }
        
        
        //echo "Subtotal" . $subtotal_mxn . "<br />";
        ...
        if($_POST["porcentaje"] == ""){
            ...
            $descuento_porcentaje = $_POST["porcentaje"];
        ...
        if($_POST["descuento"] == ""){
            ...
            $descuento_precio = $_POST["descuento"];
        }
        /*
        tipo_cambio
        descuento
        ...
        */
        ...
        //$qry_insert_venta = "insert into ds_tbl_venta (Id_Venta, Id_Cliente, Fecha_Venta, MontoTotal, Id_Evento, TipoCambio, MontoTotalMXN, IdEmpleado, DescuentoPorcentaje, DescuentoPrecio, ExcentarIva, SubtotalMXN) values ($id_venta, $id_cliente, '{$fecha_actual}', $monto_total_dolar,  $id_evento, $dolar_valor, $monto_total, $id_empleado, $descuento_porcentaje, $descuento_precio, $excentar_iva_val, $subtotal_mxn)";
        //$descuento_mxn
        $qry_insert_venta = "insert into ds_tbl_venta (Id_Venta, Id_Cliente, Fecha_Venta, MontoTotal, Id_Evento, TipoCambio, MontoTotalMXN, IdEmpleado, DescuentoPorcentaje, DescuentoPrecio, ExcentarIva, SubtotalMXN, DescuentoMXN) values ($id_venta, $id_cliente, '{$fecha_actual}', $monto_total_dolar,  $id_evento, $dolar_valor, $monto_total, $id_empleado, $descuento_porcentaje, $descuento_precio, $excentar_iva_val, $subtotal_mxn, $descuento_mxn)";
        //
        ...
        foreach($_SESSION["producto"] as $producto){
            ...
            $last_id_venta_detalle = $obj->get_row("select * from ds_tbl_venta_detalle order by Id_Venta_Detalle desc limit 1");
            $next_id_venta_detalle = $last_id_venta_detalle->Id_Venta_Detalle + 1;
            ...
            $qry_insert_venta_detalle = "insert into ds_tbl_venta_detalle (Id_Venta_Detalle, Id_Producto_Detalle, Cantidad, MontoVenta, Id_Venta, Id_Motivo_Devolucion) values ($next_id_venta_detalle, $id_producto_detalle, $cantidad_val, $precio_val, $id_venta, 0)";
            //echo $qry_insert_venta_detalle;
    ...
    <div>
    	<div>
    		<div>
    			<button class="btn waves-effect waves-light bg_aguitech" type="button" name="action" onclick="cancelar_venta('<?php echo $id_venta; ?>')"><i class="material-icons right">add</i> Cancelar venta</button>
    		...
    		<div class="form-row">
        		...
        		<div class="form-group col-md-4">
        			Monto Total MXN:<br />
        			<b style="font-size:20px;">$<?php echo number_format($detalle_venta->MontoTotalMXN, 2); ?>MXN</b>
    		
        		</div>
        		<div class="form-group col-md-4">
        			Monto Total USD:<br />
        			<b style="font-size:20px;">$<?php echo number_format($detalle_venta->MontoTotal, 2); ?>USD</b>
