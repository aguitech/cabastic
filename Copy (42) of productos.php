...
$productos = $obj->get_results("select * from ds_tbl_producto order by Descripcion asc");
						...
						<div class="form-row">
                            <div class="form-group col-md-6">
                             	...
                             	<div id="resultado_filtrado_marca">
                                    <select name="id_producto" id="id_producto" class="form-control" onclick="actualizar_producto();">
