...
$precio_actual = $_GET["precio_actual"];
...
// Email subject
$mail->Subject = 'Alerta de costo';

// Set email format to HTML
$mail->isHTML(true);

// Email body content
$mailContent = "<h3>Actualizaci&oacute;n de costo</h3>
        <p>Se ha modificado el costo.</p>";
...
$mailContent .= "Costo Actual: " . $_GET["costo_nuevo"] . "<br />";
$mailContent .= "Costo Anterior: " . $_GET["costo_actual"] . "<br />";
$mailContent .= "Divisa: " . $_GET["divisa"] . "<br />";
