        ...
        <div style="font-family:verdana;">
        	...
        	<div id="graph_home_days">
            	<div style="height:300px;  width:100%; display:flex; align-items:baseline; justify-content:center;">
            		...
            		?>
            		<div class="graph_home" onclick="mostrar_horarios_home(1)" style="height:<?php echo $percent_vie; ?>%;"></div>
                	<?php 
            		...
            		?>
            		<div class="graph_home" onclick="mostrar_horarios_home(1)" style="height:<?php echo $percent_sab; ?>%;"></div>
                	<?php 
            		...
            		?>
            		<div class="graph_home" onclick="mostrar_horarios_home(1)" style="height:<?php echo $percent_dom; ?>%;"></div>
            	...
            	<div style="height:30px;  width:100%; display:flex; align-items:baseline; justify-content:center;">
                	...
                	<div class="graph_home_percent" style=""><?php echo $percent_vie; ?>%</div>
                	<div class="graph_home_percent" style=""><?php echo $percent_sab; ?>%</div>
                	<div class="graph_home_percent" style=""><?php echo $percent_dom; ?>%</div>
            	</div>
            </div>
