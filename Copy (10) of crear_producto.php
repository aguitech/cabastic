			...
			<div class="form-row">
                <div class="form-group col-md-6">
                	...
                	<div style="display:none;" id="contenedor_agregar_sustancia" class="contenedor_dinamico_producto">
                		<input type="text" placeholder="Descripcion" id="descripcion_sustancia" value="<?php echo $resultado->Descripcion; ?>"  class="form-control" />
                ...
                <div class="form-group col-md-6">
                	...
                	<div style="display:none;" id="contenedor_agregar_marca" class="contenedor_dinamico_producto">
                		<input type="text" placeholder="Descripcion" id="descripcion_marca" value="<?php echo $resultado->Descripcion; ?>"  class="form-control" />
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                	...
                	<div style="display:none;" id="contenedor_agregar_tipo_producto" class="contenedor_dinamico_producto">
                		<input type="text" placeholder="Descripcion" id="descripcion_tipo_producto" value="<?php echo $resultado->Descripcion; ?>"  class="form-control" />
                ...
                <div class="form-group col-md-6">
               		...
               		<div style="display:none;" id="contenedor_agregar_categoria_producto" class="contenedor_dinamico_producto">
                		...
                		<br />
                		<input type="text" placeholder="Descripcion" id="descripcion_categoria_producto" value="<?php echo $resultado->Descripcion; ?>"  class="form-control" />
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                	...
                	<div style="display:none;" id="contenedor_agregar_talla" class="contenedor_dinamico_producto">
                		<input type="text" placeholder="Descripcion" id="descripcion_talla" value="<?php echo $resultado->Descripcion; ?>"  class="form-control" />
                ...
                <div class="form-group col-md-6">
                	...
                	<div style="display:none;" id="contenedor_agregar_genero" class="contenedor_dinamico_producto">
                		<input type="text" placeholder="Descripcion" id="descripcion_genero" value="<?php echo $resultado->Descripcion; ?>"  class="form-control" />
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                	...
                	<div style="display:none;" id="contenedor_agregar_tipo_mercado" class="contenedor_dinamico_producto">
                		<input type="text" placeholder="Descripcion" id="descripcion_tipo_mercado" value="<?php echo $resultado->Descripcion; ?>"  class="form-control" />
                ...
                <div class="form-group col-md-6">
                	...
                	<div style="display:none;" id="contenedor_agregar_color" class="contenedor_dinamico_producto">
                		<input type="text" placeholder="Descripcion" id="descripcion_color" value="<?php echo $resultado->Descripcion; ?>"  class="form-control" />
