				...
				<div class="card" id="container">
					...
					<table class="table datatable-basic">
						...
						<tbody>
							...
							<?php 
							$qry_venta_detalle = "select * from ds_tbl_venta_detalle where Id_Venta = $id_venta";
							//echo $qry_venta_detalle;
							//$resultados = $obj->get_results($qry_resultados);
							$venta_detalle = $obj->get_row($qry_venta_detalle);
						
							$id_venta_detalle = $venta_detalle->Id_Venta_Detalle;
							//$id_venta_detalle =  $venta_detalle->Id_Venta_Detalle;
							echo $id_venta_detalle;
							/**
