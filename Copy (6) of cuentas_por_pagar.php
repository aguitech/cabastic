...
if($_POST["Monto"] != ""){
    ...
    $val_comprobante_pago = $_POST["Comprobante_Pago"];
    ...
    if($_POST["editar"] != ""){
        ...
        if($_FILES["Comprobante_Pago"]['name'] != ""){
            ...
            $prefix_fecha = "comprobante_" . date("YmdHis") . "_";
            //$destino = '../../../images/blog';
            $destino = 'images/cuenta_pagar';
            
            $name_imagen_url_comprobante = $prefix_fecha . $_FILES['Comprobante_Pago']['name'];
            
            //copy($_FILES['blogfoto']['tmp_name'][$i], $destino . '/' . $prefix_fecha . $_FILES['blogfoto']['name'][$i]);
            copy($_FILES['Comprobante_Pago']['tmp_name'], $destino . '/' . $name_imagen_url_comprobante);
        ...
        //
        if($_SESSION["rol"] == 1){
            $qry_edit = "update ds_tbl_cuenta_pagar set Estatus_Pago = {$val_estatus_pago}, Comprobante_Pago = '{$name_imagen_url_comprobante}' where Id_Cuenta_Pagar = $id_editar";
            
        }else{
            $qry_edit = "update ds_tbl_cuenta_pagar set Monto = '{$val_monto}', Fecha = '{$val_fecha}', Comprobante = '{$name_imagen_url}' where Id_Cuenta_Pagar = $id_editar";
        ...
        //echo $qry_insert;
        $qry_insert = "insert into ds_tbl_cuenta_pagar (Id_Empleado, Monto, Fecha, Comprobante) values ({$val_id_empleado}, '{$val_monto}', '{$val_fecha}', '{$name_imagen_url}')";
				...
				<div class="card" id="container">
					...
					<table class="table datatable-basic">
						...
						*/
						...
						$qry_resultados = "select * from $tbl_main order by $tbl_main.fecha desc";
