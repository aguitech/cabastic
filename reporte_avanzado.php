...
function filtrar_categoria(){
    ...
    $.ajax({
         ...
         data: { marcas:marcas, anio:anio, filtrar_por:filtrar_por, tipo_reporte:tipo_reporte },
...
<div style="display:none;" id="filtrado_marcas" class="filtrados_generales">
     ...
     <div class="form-group col-md-6">
         ...
         <?php endforeach; ?>
                    ...
                    <div style="display:none; background:orange;" id="filtrado_tipos_productos" class="filtrados_generales">
						<div class="form-row">
                            <div class="form-group col-md-6">
                              <div>A&ntilde;o:</div>
     					...
     					<div class="form-row">
                           ...
                           <div>
                             <button onclick="agregar_nuevo_filtrado_tipo_producto();">Agregar nuevo filtrado</button>
						</div>
