            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                	...
                	<select name="marca" id="marca" class="form-control">
               			...
               			<option value="<?php echo $tipo_producto->Id_Tipo_Producto; ?>" name="tipo_producto" id="tipo_producto"><?php echo $tipo_producto->Descripcion; ?></option>
               			<?php endforeach; ?>
               		</select>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                	...
                	<select name="marca" id="marca" class="form-control">
               			...
               			<option value="<?php echo $tipo_mercado->Id_Tipo_Mercado; ?>" name="tipo_mercado" id="tipo_mercado"><?php echo $tipo_mercado->Descripcion; ?></option>
               			<?php endforeach; ?>
               		</select>
                ...
                <div class="form-group col-md-6">
               		...
               		<select name="talla" id="talla" class="form-control">
               			...
               			<option value="<?php echo $color->Id_Color; ?>"  name="color" id="color"><?php echo $talla->Descripcion; ?></option>
               			<?php endforeach; ?>
               		</select>
