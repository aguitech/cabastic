...
<div style="padding:25px;" id="resultado_pago">
    ...
    <div class="form-row">
    	<div class="form-group col-md-4">
			...
			?>
			<?php //echo $detalle_venta->Fecha_Venta; ?>
            <br />
            Monto Total MXN: $<?php echo number_format($detalle_venta->MontoTotalMXN, 2); ?>MXN
            <br />
            Monto Total USD: $<?php echo number_format($detalle_venta->MontoTotal, 2); ?>MXN
        ...
        <div class="form-group col-md-4">
    		...
    		Monto Total MXN: $<?php 
            $monto_acumlado_dolar = $monto_acumulado * $tipo_cambio_dolar; 
            echo number_format($monto_acumlado_dolar, 2);
            ?>
            <br />
            Monto Total USD: $<?php echo number_format($monto_acumulado, 2); ?>
            
            		
    	</div>
    	<div class="form-group col-md-4">
    		<h2>Monto restante</h2>
            Monto Restante MXN: $<?php 
             $monto_restante_mxn = $detalle_venta->MontoTotalMXN - $monto_acumulado;
             echo number_format($monto_restante_mxn, 2);
            ?>
            <br />
            Monto Restante USD: $<?php 
            $monto_restante_usd = $detalle_venta->MontoTotal - $monto_acumlado_dolar;
