				...
				<div class="card" id="container">
					...
					*/
					...
					<div>
						...
						echo "Monto total: " . $resultado->MontoTotalMXN . "<br />";
						echo $resultado->Nombre . " " . $resultado->Apellido_Paterno . " " . $resultado->Apellido_Materno . " " . "<br />";
...
<form method="post" action="">
						...
						<?php foreach($prductos_ventas as $resultado): ?>
							...
							<tr id="element<?php echo $id_resultado; ?>">
								<td>
									...
									<select name="cantidad_venta[<?php echo $id_resultado; ?>]">
					...
					<table class="table datatable-basic">
						...
						<tbody>
							...
							$qry_pagos = "select * from ds_tbl_entrega_venta_productos left join ds_tbl_clientes on ds_tbl_entrega_venta_productos.Id_Cliente = ds_tbl_clientes.Id_Cliente where ds_tbl_entrega_venta_productos.Id_Venta = $id_venta";
							//echo $qry_pagos;
							//$resultados = $obj->get_results($qry_resultados);
							$pagos = $obj->get_results($qry_pagos);
							//print_r($pagos);
