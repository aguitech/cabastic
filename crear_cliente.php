...
*/ ?>
            ...
            <div class="form-row">
            	...
            	<div class="form-group col-md-6">
             		...
             		<div>C&oacute;digo de Cliente</div>
    				<input type="text" placeholder="Codigo de Cliente" name="Codigo_Cliente" id="Apellido_Materno" value="<?php echo $resultado->Codigo_Cliente; ?>"  class="form-control" />
            	</div>
            </div>
            <div class="form-row">
            	<div class="form-group col-md-6">
            ...
            <div class="form-row">
            	<div class="form-group col-md-6">
    				...
    				<?php
    				if($resultado->Limite_Credito != ""):
    				    $limite_credito = $resultado->Limite_Credito;
    				else:
    				    $limite_credito = 0;
    				endif;
    				?>
    				<input type="text" placeholder="Limite de Cr&eacute;dito" name="Limite_Credito" id="Limite_Credito" value="<?php echo $limite_credito; ?>"  class="form-control" />
            	</div>
            	<div class="form-group col-md-6">
                
             		<div>Plazo de Cr&eacute;dito</div>
             		<?php
             		if($resultado->Plazo_Credito != ""):
    				    $plazo_credito = $resultado->Limite_Credito;
    				else:
    				    $plazo_credito = 0;
    				endif;
    				?>
    				<input type="text" placeholder="Plazo de Cr&eacute;dito" name="Plazo_Credito" id="Plazo_Credito" value="<?php echo $plazo_credito; ?>"  class="form-control" />
            	</div>
            </div>
...
*/ ?>            
            ...
            <div class="form-row">
            	<div class="form-group col-md-12">
            		...
            		<?php if($datos_envios == Array()): ?>
            			<h2>Sin direcciones de env&iacute;o</h2>
            		<?php else: ?>
