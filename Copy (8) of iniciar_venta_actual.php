...
<div>
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-6">
         	<div>Total MXN</div>
 			<input type="text" placeholder="Apellido Paterno" name="Apellido_Paterno" id="Apellido_Paterno" readonly="readonly" value="$<?php echo number_format($importe_total, 2); ?>" class="form-control" />
        </div>
    </div>
    <div class="form-row">
        <div class="form-group col-md-6">
