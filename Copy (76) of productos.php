...
/**
	   ...
	   function vista_previa(url_imagen){
		...
		<div class="content-wrapper">
			...
			<div class="content">
				...
				<div class="card" id="container">
					<div style="position:absolute; z-index:10; height:100%; background:orange; width:calc(100% - 40px);">
						Hola
					</div>
    					...
    					<table class="table datatable-basic">
    						...
    						<?php foreach($resultados as $resultado): ?>
    							...
    							<tr id="element<?php echo $id_resultado; ?>">
    								...
    								*/ ?>
    								<td><?php if($resultado_imagen_val->Url_Imagen != ""): ?><img src="images/productos/<?php echo $resultado_imagen_val->Url_Imagen; ?>" style="max-height:50px; max-width:100px;" onclick="vista_previa('<?php echo $resultado_imagen_val->Url_Imagen; ?>');" /><?php endif; ?></td>
