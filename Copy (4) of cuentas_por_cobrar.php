...
$url_name = "cuentas_por_cobrar.php";
?>
...
<body>
	...
	<div id="banner_contenido" style="position:fixed; top:0; left:0; right:0; bottom:0; z-index:101; display:none;">
		<div style="width:100%; height:100%;">
			<div style="margin:10%; padding:3%; background:white; height:74%; overflow-x:scroll;">
...
function guardar_pago(){
	...
	*/
    ...
    formData.append('moneda_pago',$("#moneda_pago").val());
...
<div class="form-row">
     ...
     */ ?>
     ...
     $qry_result = "select sum(ds_tbl_venta.MontoTotalMXN) as total from ds_tbl_venta left join ds_tbl_venta_metodo_pago on ds_tbl_venta.Id_Venta = ds_tbl_venta_metodo_pago.Id_Venta where ds_tbl_venta.Id_Cliente = $id_resultado and ds_tbl_venta_metodo_pago.Id_Metodo_Pago = 4";
     //echo $qry_result;
     //exit;
