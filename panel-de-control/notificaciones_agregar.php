			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Agregar Notificación</h5>
					...
					<div class="card-body">
						<p class="mb-4">
							...
							En esta interface puede agregar usuarios nuevos mensajes para los usuarios de la <code>Intranet</code>

						</p>

						<form action="notificaciones_agregar_form.php">
							<fieldset class="mb-3">
								<legend class="text-uppercase font-size-sm font-weight-bold">Rellena los campos</legend>

								<div class="form-group row">
									<label class="col-form-label col-lg-2">Titulo</label>
									<div class="col-lg-10">
										<input  type="text" class="form-control"  autocomplete="off" value="" name="nombre">
									</div>
								</div>

								<div class="form-group row">
									<label class="col-form-label col-lg-2">Contenido del mensaje</label>
									<div class="col-lg-10">
										<textarea name="descripcion" style="width: 100%; height: 300px;"></textarea>
									</div>
								</div>
