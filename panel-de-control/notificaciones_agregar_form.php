			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Notificaciones</span> - Agregar</h4>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Notificación agregada (<?php echo $nombre; ?>)</h5>
					...
					$qt = " 
							INSERT INTO `intranet_notificaciones` (`id_notificacion`, `titulo`, `descripcion`, `fecha`) 
							VALUES (NULL, '$nombre', '$descripcion', now());
					...
					<div class="card-body">
						<p class="mb-4">
							...
							Esta notificación (mensaje) ha sido agregada a la <code>Intranet</code>
