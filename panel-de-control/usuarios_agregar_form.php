			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Usuario agregado (<?php echo $completo; ?>)</h5>
					...
					$qt = "INSERT INTO `intranet_usuario` (`id_usuario`, `nombre`, `pass`, `id_nivel`, `extension`, `area`, `completo`) 
					VALUES (NULL, '$email', '$password', '$id_nivel', '$extension', '$area', '$completo');";
					$resultt = $mysqli->query($qt);


					$qt = "SELECT * FROM intranet_nivel WHERE id_nivel='$id_nivel' ORDER BY id_nivel DESC LIMIT 30";
					...
					<div class="card-body">
						<p class="mb-4">
							...
							Este usuario ha sido agregado a la <code>Intranet</code>
