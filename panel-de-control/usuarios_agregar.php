				...
				<div class="card">
					...
					<div class="card-body">
						<p class="mb-4">
							...
							En esta interface puede agregar usuarios nuevos con acceso a la <code>Intranet</code>

						</p>

						<form action="usuarios_agregar_form.php">
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input  type="text" class="form-control"  autocomplete="off" value="" name="email">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input  class="form-control"  autocomplete="off" value="" name="password">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="###" name="extension">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input type="text" class="form-control" name="completo" >
									</div>
								</div>
