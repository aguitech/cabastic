...
<head>
	...
	<script type="text/javascript">
		...
		function Eliminar(t_id,t_completo){
			...
			var r = confirm("Estás seguro que deseas eliminar la notificación: "+t_completo);
			if (r == true) {
			  txt = "You pressed OK!";

			  	$.ajax({url: "notificaciones_eliminar.php?id="+t_id, success: function(result){
    				//$("#div1").html(result);
    				//alert(result);
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Notificaciones</span> - Listado</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							<a href="usuarios.php" class="breadcrumb-item"><i class="icon-home2 mr-2"></i> Home</a>
							<a href="notificaciones.php" class="breadcrumb-item">Notificaciones</a>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Notitficaciones</h5>
					...
					<div class="card-body">
						La lista de <code>Notificaciones</code> muestra todos los mensajes para los usuarios de la <code>intranet</code>.
					</div>
					...
					<table class="table datatable-basic">
                        ...
                        <?php 
                         	...
                         	$sq="SELECT count(*) FROM intranet_usuario  ";
                         ...
                         $qt = "SELECT * FROM intranet_notificaciones ORDER BY id_notificacion DESC LIMIT 30";
                         
                          $resultt = $mysqli->query($qt);
                          while ($rowt = $resultt->fetch_row()){

                            $id_notificacion=$rowt[0];
                            $nombre=$rowt[1];
                            $descripcion=$rowt[2];
                            $fecha=$rowt[3];

                            $sq="SELECT count(*) FROM intranet_notificaciones_visto WHERE id_notificacion='$id_notificacion' ";
                            $resul = $mysqli->query($sq);
                          	while ($row = $resul->fetch_row()){
                        ...
                        ?>  
							<tr id="element<?php echo $id_notificacion; ?>">
								<td><?php echo $id_notificacion; ?></td>
								<td><a href="notificaciones_editar.php?id=<?php echo $id_usuario; ?>"><?php echo $nombre; ?></td>
								...
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<a href="#" class="dropdown-item" onclick="Eliminar(<?php echo $id_notificacion; ?>,'<?php echo " (".$nombre.")"; ?>');"><i class="icon-bin"></i> Remove</a>
