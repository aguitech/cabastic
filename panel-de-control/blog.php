		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Blog</span> - Listado</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="datatable_basic.html" class="breadcrumb-item">Blog</a>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						El <code>Blog</code> es la parte del sitio que permite publicar contenidos relacionados con Adek, y ayuda a que los usuarios encuentren el sitio buscando temas que le parecen <strong>interesantes.</strong>
					</div>
					...
					<table class="table datatable-basic">
                        ...
                        <?php 
                         $qt = "SELECT * FROM entrada ORDER BY id_entrada DESC LIMIT 30";
                        ...
                        ?>  
							<tr>
								...
								<td>
									<a href="/blog-de-manufactura-e-industria/?k=<?php echo $permalink; ?>" target="_blank">
									<?php echo $permalink; ?>
									</a>
								</td>
								<td><?php echo $introduccion; ?></td>
									...
									<div class="list-icons">
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												...
												<a href="blog_editar.php?id=<?php echo $id_entrada; ?>" class="dropdown-item"><i class="icon-pencil4"></i> Editar</a>
												<a href="#" class="dropdown-item"><i class="icon-stack-cancel"></i> Desactivar</a>
											</div>
										</div>
									</div>
								</td>
