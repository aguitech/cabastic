...
stdClass Object ( [Id_Venta] => 892 [Id_Cliente] => 228 [Fecha_Venta] => 2021-06-18 22:30:17 
[MontoTotal] => 87.06 [Id_Evento] => 1 [ExcentarIva] => 0 [DescuentoPorcentaje] => 0 [DescuentoPrecio] => 0.00 [TipoCambio] => 22.00 [SubtotalMXN] => 1651.1 [MontoTotalMXN] => 1915.28 [DescuentoMXN] => 0 [IdEmpleado] => 1 [plazo] => 0 [frecuencia] => 0 [id_Motivo_Cancelacion] => 0 [fecha_Cancelacion] => ) 

select * from ds_tbl_venta_detalle left join ds_tbl_producto_detalle on ds_tbl_venta_detalle.Id_Producto_Detalle = ds_tbl_producto_detalle.Id_Producto_Detalle left join ds_tbl_producto on ds_tbl_producto_detalle.Id_Producto = ds_tbl_producto.Id_Producto where ds_tbl_venta_detalle.Id_Venta = 892
Array ( [0] => stdClass Object ( [Id_Venta_Detalle] => 1334 [Id_Producto_Detalle] => 900 [Cantidad] => 1 [MontoVenta] => 1650.00 [Id_Venta] => 892 [id_Motivo_Devolucion] => 0 [fecha_Devolucion] => [Codigo_Barras] => A101751030 [Id_Talla] => 1 [Id_Color] => 1 [Id_Producto] => 900 [Id_Tipo_Mercado] => 6 [Id_Genero] => 1 [Activo] => 1 [Nombre] => SELEVIT [Descripcion] => FRASCO DE 100ML [Imagen_Producto] => [Id_Marca] => 36 [Id_Tipo_Producto] => 9 [Id_Tipo_Sustancia] => 1 [Fecha_Alta] => 2020-07-22 23:57:15 [Id_Categoria_Producto] => 46 ) [1] => stdClass Object ( [Id_Venta_Detalle] => 1335 [Id_Producto_Detalle] => 863 [Cantidad] => 1 [MontoVenta] => 1.10 [Id_Venta] => 892 [id_Motivo_Devolucion] => 0 [fecha_Devolucion] => [Codigo_Barras] => 0100404200031 [Id_Talla] => 1 [Id_Color] => 1 [Id_Producto] => 863 [Id_Tipo_Mercado] => 6 [Id_Genero] => 1 [Activo] => 1 [Nombre] => BIZZY BITES DULCES REFIL (1)KG (ORIGINAL REFIL) [Descripcion] => SABOR ORIGINAL REFIL [Imagen_Producto] => [Id_Marca] => 18 [Id_Tipo_Producto] => 7 [Id_Tipo_Sustancia] => 1 [Fecha_Alta] => 2020-07-21 22:20:43 [Id_Categoria_Producto] => 1 ) ) 
*/
...
$pdf->setX(2);
//acentos
$str_dir3 = iconv('UTF-8', 'windows-1252', "Cuautitlán Izcalli, Méx.");
$pdf->Cell(5,$textypos,$str_dir3);
...
$val_guiones = iconv('UTF-8', 'windows-1252', '——————————————————————-');
$pdf->Cell(5,$textypos,$val_guiones);
$textypos+=6;
$pdf->setX(2);
...
$pdf->Cell(5,$off,$val_cantidad);
$pdf->setX(6);
//$str_dir3 = iconv('UTF-8', 'windows-1252', "Cuautitlán Izcalli, Méx.");
//$val_nombre = $pro->Nombre;
$val_nombre = iconv('UTF-8', 'windows-1252', $pro->Nombre);
$pdf->Cell(35,$off,  strtoupper(substr($val_nombre, 0,12)) );
$pdf->setX(20);
$val_precio = $pro->MontoVenta;
$pdf->Cell(11,$off,  "$".number_format($val_precio,2,".",",") ,0,0,"R");
$pdf->setX(32);
//$pdf->Cell(11,$off,  "$ ".number_format($pro["q"]*$pro["price"],2,".",",") ,0,0,"R");
//echo $pro->Cantidad . "<br />";
$val_cantidad_precio = $pro->Cantidad * $pro->MontoVenta;
$pdf->Cell(11,$off,  "$ ".number_format($val_cantidad_precio,2,".",",") ,0,0,"R");

//$total += $pro["q"]*$pro["price"];
$total += $pro->Cantidad * $pro->MontoVenta;
$off+=6;
}
$textypos=$off+6;
...
//$pdf->Image('leon.jpg' , 80 ,22, 100 , 100,'JPG', 'http://www.desarrolloweb.com');
$pdf->Image('http://cabastic.info/leon.jpg' , 80 ,22, 100);
