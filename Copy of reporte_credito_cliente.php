...
$nombre_seccion = "Reporte Cr&eacute;dito de Cliente";
...
<div class="form-row">
     ...
     */ ?>
     ...
     <td onclick="filtrar_cliente(<?php echo $id_resultado; ?>)"><?php echo " &nbsp; $ " . $resultado->Monto . " USD"; ?></td>
    
     <td onclick="filtrar_cliente(<?php echo $id_resultado; ?>)"><div style="width:20px; height:20px; border-radius:100%; background:<?php echo $hexadecimal; ?>"></div></td>
     <td onclick="filtrar_cliente(<?php echo $id_resultado; ?>)"><?php echo $resultado->Fecha_Venta; ?></td>
     ...
     */ ?>
     ...
     <div class="dropdown-menu dropdown-menu-right">
     <a onclick="cargar_editar('<?php echo $id_resultado; ?>')" class="dropdown-item"><i class="icon-pencil4"></i> Registrar pago</a>
     <?php /**
