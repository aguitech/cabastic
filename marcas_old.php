			...
			<div class="content">
				...
				<div class="card">
					...
					<table class="table datatable-basic">
						...
						<?php 
						$qry_marcas = "select * from ds_cat_marca order by Descripcion asc";
						
						$marcas = $obj->get_results($qry_marcas);
						...
						//exit();
						?>
						<tr id="element<?php echo $marca->Id_Marca; ?>">
								<?php /**?>
								<td><a href="usuarios_editar.php?id=<?php echo $marca->Id_Marca; ?>"><?php echo $marca->Id_Marca; ?></td>
								*/ ?>
								<td><?php if($marca->Logo != ""): ?><img src="images/marcas/<?php echo $marca->Logo; ?>" style="max-height:50px; max-width:100px;" /><?php endif; ?></td>
								<td><?php echo $marca->Descripcion; ?></td>
								<td><?php if($marca->Activo == 1): echo "Activo"; else: echo "Inactivo"; endif; ?></td>
