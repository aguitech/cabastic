					...
					<table class="table datatable-basic">
						...
						*/
						...
						<?php foreach($resultados as $resultado): ?>
							...
							$extension=$resultado->Colonia;
							$area=$resultado->Id_Codigo_Postal;
							$completo="Hola";
							$niveles="Hola";
							?>
									...
									<div class="list-icons">
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												...
												<a onclick="cierre_evento('<?php echo $id_resultado; ?>')" class="dropdown-item"><i class="icon-pencil4"></i> Cierre de evento</a>
