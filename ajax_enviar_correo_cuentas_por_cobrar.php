...
// Email subject
$mail->Subject = 'Recordatorio de pago retrasado';

// Set email format to HTML
$mail->isHTML(true);

// Email body content
$mailContent = "<h3>Actualizaci&oacute;n de precio</h3>
        <p>Se han modificado el precio.</p>";
...
$qry_result = "select sum(ds_tbl_venta.MontoTotal) as total from ds_tbl_venta left join ds_tbl_venta_metodo_pago on ds_tbl_venta.Id_Venta = ds_tbl_venta_metodo_pago.Id_Venta where ds_tbl_venta.Id_Cliente = $id_cliente and ds_tbl_venta_metodo_pago.Id_Metodo_Pago = 4";
//echo $qry_result;
//exit;
