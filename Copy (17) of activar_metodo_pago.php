...
<div style="padding:25px; margin-top:1px solid gray;">
    ...
    <div>
    	...
    	<div class="form-row">
            ...
            <div class="form-group col-md-3">
    			<input type="text" placeholder="Billete" name="billete_1000" id="billete_1000" value="" class="form-control" onkeyup="calcular_billetes_1000(this.value)" />
            	
    		</div>
    		<div class="form-group col-md-3" id="resultado_billete_1000">
    			<input type="text" readonly="readonly" placeholder="Billete" name="resultado_billete_1000" id="resultado_billete_1000" value="" class="form-control" />
    	...
    	<div class="form-row">
            ...
            <div class="form-group col-md-3">
    			<input type="text" placeholder="Billete" name="billete_500" id="billete_500" value="" class="form-control" onkeyup="calcular_billetes_500(this.value)" />
            	
    		</div>
    		<div class="form-group col-md-3" id="resultado_billete_500">
    			<input type="text" readonly="readonly" placeholder="Billete" name="resultado_billete_500" id="resultado_billete_500" value="" class="form-control" />
    	...
    	<div class="form-row">
            ...
            <div class="form-group col-md-3">
    			<input type="text" placeholder="Billete" name="billete_200" id="billete_200" value="" class="form-control" onkeyup="calcular_billetes_200(this.value)" />
            	
    		</div>
    		<div class="form-group col-md-3" id="resultado_billete_200">
    			<input type="text" readonly="readonly" placeholder="Billete" name="resultado_billete_200" id="resultado_billete_200" value="" class="form-control" />
    	...
    	<div class="form-row">
            ...
            <div class="form-group col-md-3">
    			<input type="text" placeholder="Billete" name="billete_100" id="billete_100" value="" class="form-control" onkeyup="calcular_billetes_100(this.value)" />
            	
    		</div>
    		<div class="form-group col-md-3" id="">
    			<input type="text" readonly="readonly" placeholder="Billete" name="resultado_billete_100" id="resultado_billete_100" value="" class="form-control" />
    	...
    	<div class="form-row">
            ...
            <div class="form-group col-md-3">
    			<input type="text" placeholder="Billete" name="billete_50" id="billete_50" value="" class="form-control" onkeyup="calcular_billetes_50(this.value)" />
            	
    		</div>
    		<div class="form-group col-md-3" id="">
    			<input type="text" readonly="readonly" placeholder="Billete" name="resultado_billete_50" id="resultado_billete_50" value="" class="form-control" />
    	...
    	<div class="form-row">
            ...
            <div class="form-group col-md-3">
    			<input type="text" placeholder="Billete" name="billete_20" id="billete_20" value="" class="form-control" onkeyup="calcular_billetes_20(this.value)" />
            	
    		</div>
    		<div class="form-group col-md-3" id="">
    			<input type="text" readonly="readonly" placeholder="Billete" name="resultado_billete_20" id="resultado_billete_20" value="" class="form-control" />
    	...
    	<div class="form-row">
    		...
    		<div class="form-group col-md-3" id="resultado_billetes">
