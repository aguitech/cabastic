...
<head>
		...
		if(confirm("¿Seguro de cancelar la venta?")){
			$.ajax({
	            ...
	            success:function(data){
	            	...
	            	//$("#container").html(data);
	            	//$("#resultado_subtotales").html(data);
	            	$('#fondo_especial').hide('slow');
	            	$('#banner_especial').hide('slow');

	            	$("#resultado_activar_metodo_pago").html("");
	            }
			});
		}
	...
	function resultado_subtotales(){
		var tipo_cambio = $("#tipo_cambio").val();
		var descuento_precio = $("#descuento_precio").val();
		var descuento_porcentaje = $("#descuento_porcentaje").val();
		
		$.ajax({
			type: "POST",
            url:"actualizar_resultado_subtotales.php",
            //data: { limit:val_limit, offset:val_offset },
            data: { tipo_cambio:tipo_cambio, descuento:descuento_precio, porcentaje:descuento_porcentaje },
            success:function(data){
            	console.log(data);
            	//$("#resultado_votos_detalle").html(data);
            	//$("#publicaciones_adicionales").html(data);
	...
	function actualizar_total_venta(){
		...
		$.ajax({
			type: "POST",
            url:"actualizar_total_venta.php",
            //data: { limit:val_limit, offset:val_offset },
            data: { id:id },
            success:function(data){
            	console.log(data);
            	...
            	//$("#publicaciones_adicionales").append(data);
            	//$("#container").html(data);
            	$("#resultado_total_venta").html(data);
            	resultado_subtotales();
            }
		});
	}
	function descuento_porcentaje_precio(valor){
		var tipo_cambio = $("#tipo_cambio").val();
		var descuento_precio = $("#descuento_precio").val();
		var descuento_porcentaje = $("#descuento_porcentaje").val();
		$.ajax({
	...
	function descuento_precio_directo(valor){
		var tipo_cambio = $("#tipo_cambio").val();
		var descuento_precio = $("#descuento_precio").val();
		var descuento_porcentaje = $("#descuento_porcentaje").val();
	...
	function descuento_tipo_cambio(valor){
		var tipo_cambio = $("#tipo_cambio").val();
		var descuento_precio = $("#descuento_precio").val();
		var descuento_porcentaje = $("#descuento_porcentaje").val();
		...
		function agregar_producto(id){
		   ...
		   function guardar_venta(){
			   ...
			   var id_evento = $("#id_evento").val();
				...
				var excentar_iva = $("#excentar_iva").prop("checked");
			   ...
			   $.ajax({
					...
					//data: { id:id, id_ship:id_ship },
//data: { tipo_cambio:tipo_cambio, descuento:descuento_precio, porcentaje:descuento_porcentaje },		            
					data: { id:id, id_ship:id_ship, id_cliente:id_cliente, id_evento:id_evento, tipo_cambio:tipo_cambio, descuento:descuento_precio, porcentaje:descuento_porcentaje, excentar_iva:excentar_iva },
					success:function(data){
						console.log(data);
						$('#fondo_especial').slideDown('slow'); $('#banner_especial').show('slow');
		...
		function limpiar_billetes(){
	    	$('#resultado_billete_1000').val("0");
	    	$('#resultado_billete_500').val("0");
	    	$('#resultado_billete_200').val("0");

	    	$('#resultado_billete_100').val("0");
	    	$('#resultado_billete_50').val("0");
	    	$('#resultado_billete_20').val("0");

	    	$('#resultado_billetes').val("0");
		             ...
		             .bold_text{
						...
						<div class="form-row">
                            <div class="form-group col-md-6">
                             	<div class="bold_text">Cliente a vender:</div>
        						<?php 
                        ...
                        */ ?>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                            	<div style="" class="bold_text contenedor_agregar_titulo">
                            		Tipo de producto
                            	</div>
						...
						<div class="form-row">
                            <div class="form-group col-md-6">
                             	<div class="bold_text">Filtro por marca:</div>
                                <?php 
                            ...
                            <div class="form-group col-md-6">
                             	<div class="bold_text">Filtro por g&eacute;nero:</div>
						...
						<div class="form-row">
                            <div class="form-group col-md-6">
                             	<div class="bold_text">Filtro por producto:</div>
                            ...
                            */ ?>
                            ...
                            <div class="form-group col-md-6">
                             	<div class="bold_text">Filtro por talla:</div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                             	<div class="bold_text">Filtro por color:</div>
    					...
    					<table class="table datatable-basic">
    						...
    						<?php foreach($resultados as $resultado): ?>
    							...
    							<tr id="element<?php echo $id_resultado; ?>">
    								...
    								<td>$<?php echo number_format(($resultado->Dolar * $tipo_cambio_dolar), 2); ?></td>
    								
    								<td>$<?php echo number_format($resultado->Dolar, 2); ?></td>
    								<td><a onclick="agregar_producto('<?php echo $id_resultado; ?>')"><i class="icon-checkmark2"></i></a></td>
    
    								<?php /**
    								<td>$<?php echo number_format($resultado->Costo_Venta, 2); ?></td>
