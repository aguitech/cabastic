                    	...
                    	<table class="table datatable-basic">
    						...
    						<?php foreach($resultados as $resultado): ?>
    							...
    							<tr id="element<?php echo $id_resultado; ?>">
    								...
    								<td><a onclick="filtrar_cliente(<?php echo $id_resultado; ?>)"><?php echo $resultado->Apellido_Paterno . " " . $resultado->Apellido_Materno . " " . $resultado->Nombre; ?></td>
    								<td><?php echo " &nbsp; $ " . $resultado->Monto . " USD"; ?></td>
