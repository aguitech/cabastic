...
<body>
	...
	<script>
	    ...
	    function actualizar_total_billetes(){
	    	$val_mil = $('#resultado_billete_1000').val();
	    	$val_quinientos = $('#resultado_billete_500').val();
	    	$val_doscientos = $('#resultado_billete_200').val();

	    	$val_cien = $('#resultado_billete_100').val();
	    	$val_cincuenta = $('#resultado_billete_50').val();
	    	$val_veinte = $('#resultado_billete_20').val();

	    	$val_total = (val_mil + val_quinientos + val_doscientos + val_cien + val_cincuenta + val_veinte);
