					...
					<div class="form-row">
                        <div class="form-group col-md-6">
                        	...
                        	<select onchange="filtrar_marca(this.value);" id="marca" class="form-control">
    							...
    							<option value="<?php echo $resultado->Id_Cliente; ?>"><?php echo $resultado->Apellido_Paterno . " " . $resultado->Apellido_Materno . " " . $resultado->Nombre; ?><?php echo " &nbsp; $ " . $resultado->Monto . " USD"; ?></option>
    							<?php endforeach; ?>
    						</select>
    						<?php /**
                         	<div>A&ntilde;o:</div>
