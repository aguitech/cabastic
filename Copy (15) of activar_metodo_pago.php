    ...
    <div>
    	...
    	<div class="form-row">
    		...
    		<div class="form-group col-md-3" id="resultado_billete_1000">
    			<input type="text" placeholder="Billete" name="resultado_billete_1000" id="resultado_billete_1000" value="" class="form-control" />
    	...
    	<div class="form-row">
    		...
    		<div class="form-group col-md-3" id="resultado_billete_500">
    			<input type="text" placeholder="Billete" name="resultado_billete_500" id="resultado_billete_500" value="" class="form-control" />
    	...
    	<div class="form-row">
    		...
    		<div class="form-group col-md-3" id="resultado_billete_200">
    			<input type="text" placeholder="Billete" name="resultado_billete_200" id="resultado_billete_200" value="" class="form-control" />
    	...
    	<div class="form-row">
    		...
    		<div class="form-group col-md-3" id="">
    			<input type="text" placeholder="Billete" name="resultado_billete_100" id="resultado_billete_100" value="" class="form-control" />
    	...
    	<div class="form-row">
    		...
    		<div class="form-group col-md-3" id="">
    			<input type="text" placeholder="Billete" name="resultado_billete_50" id="resultado_billete_50" value="" class="form-control" />
    	...
    	<div class="form-row">
    		...
    		<div class="form-group col-md-3" id="">
    			<input type="text" placeholder="Billete" name="resultado_billete_20" id="resultado_billete_20" value="" class="form-control" />
