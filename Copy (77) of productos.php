	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="content">
				...
				<div id="fondo_vista_previa" style="position:fixed; top:0; left:0; right:0; bottom:0; z-index:100; background:rgba(0,0,0,.4);">
					
				</div>
				<div id="banner_vista_previa" style="position:fixed; top:0; left:0; right:0; bottom:0; z-index:101;" onclick="$('#fondo_vista_previa').hide(); $('#banner_vista_previa').hide();">
					<div style="width:100%; height:100%; display:flex; align-items:center; justify-content:center;">
						<?php /**
    					...
    					<table class="table datatable-basic">
    						...
    						<?php foreach($resultados as $resultado): ?>
    							...
    							<tr id="element<?php echo $id_resultado; ?>">
    								...
    								*/ ?>
    								<td><?php if($resultado_imagen_val->Url_Imagen != ""): $url_img = $resultado_imagen_val->Url_Imagen; ?><img src="images/productos/<?php echo $resultado_imagen_val->Url_Imagen; ?>" style="max-height:50px; max-width:100px;" onclick="alert('hey'); vista_previa_mostrar('<?php echo $url_img; ?>'); alert('hey2');" /><?php endif; ?></td>
