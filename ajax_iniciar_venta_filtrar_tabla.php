...
<table class="table datatable-basic">
	...
	<?php 
	$where_append = "";
	if($id_marca != "" || $id_genero != "" || $id_almacen != "" || $id_tipo_producto != "" || $id_categoria != "" || $id_talla != "" || $id_color != "" || $id_categoria != "" || $id_producto != "" ||  $id_evento != ""){
	    ...
	    if($id_evento != ""){
	        ...
	        $where_append .= "ds_tbl_inventario_evento.Id_Evento = $id_evento";
	    }
	    
	    if($id_evento != "" && ($id_marca != "" || $id_genero != "" || $id_almacen != "" || $id_tipo_producto != "" || $id_talla != "" || $id_color != "" || $id_categoria != "" || $id_producto != "")){
	        $where_append .= " and ";
    ...
    */
    ...
    if($id_evento == 1){
        ...
        //$qry_resultados = "select *, ds_cat_marca.Descripcion as marca, ds_cat_talla.Descripcion as talla, ds_cat_color.Descripcion as color, ds_tbl_producto.Descripcion as descripcion_producto, ds_cat_tipo_producto.Descripcion as tipo_producto, ds_tbl_inventario_evento.Cantidad as Cantidad_Inventario, ds_cat_categoria_producto.Descripcion as categoria, ds_tbl_costo_compra_producto.Dolar as dolar_costo, ds_tbl_precio_venta_producto.Dolar as dolar_precio from ds_tbl_producto left join ds_tbl_producto_detalle on ds_tbl_producto_detalle.Id_Producto = ds_tbl_producto.Id_Producto left join ds_cat_marca on ds_cat_marca.id_marca = ds_tbl_producto.Id_Marca left join ds_tbl_precio_venta_producto on ds_tbl_precio_venta_producto.Id_Producto_Detalle = ds_tbl_producto_detalle.Id_Producto_Detalle left join ds_cat_tipo_producto on ds_cat_tipo_producto.Id_Tipo_Producto = ds_tbl_producto.Id_Tipo_Producto left join ds_cat_color on ds_cat_color.Id_Color = ds_tbl_producto_detalle.Id_Color left join ds_cat_talla on ds_cat_talla.Id_Talla = ds_tbl_producto_detalle.Id_Talla left join ds_tbl_inventario_evento on ds_tbl_inventario_evento.Id_Producto_Detalle = ds_tbl_producto_detalle.Id_Producto_Detalle left join ds_tbl_costo_compra_producto on ds_tbl_costo_compra_producto.Id_Producto_Detalle = ds_tbl_producto_detalle.Id_Producto_Detalle left join ds_tbl_cantidad_minima_producto on ds_tbl_cantidad_minima_producto.Id_Producto_Detalle = ds_tbl_producto_detalle.Id_Producto_Detalle left join ds_cat_categoria_producto on ds_cat_categoria_producto.Id_Categoria_Producto = ds_tbl_producto.Id_Categoria_Producto $where_append group by ds_tbl_producto_detalle.Id_Producto_Detalle order by $tbl_main.Descripcion asc";
        //
        $qry_resultados = "select *, ds_cat_marca.Descripcion as marca, ds_cat_talla.Descripcion as talla, ds_cat_color.Descripcion as color, ds_tbl_producto.Descripcion as descripcion_producto, ds_cat_tipo_producto.Descripcion as tipo_producto, ds_tbl_inventario_evento.Cantidad as Cantidad_Inventario, ds_cat_categoria_producto.Descripcion as categoria, ds_tbl_costo_compra_producto.Dolar as dolar_costo, ds_tbl_precio_venta_producto.Dolar as dolar_precio from ds_tbl_producto left join ds_tbl_producto_detalle on ds_tbl_producto_detalle.Id_Producto = ds_tbl_producto.Id_Producto left join ds_cat_marca on ds_cat_marca.id_marca = ds_tbl_producto.Id_Marca left join ds_tbl_precio_venta_producto on ds_tbl_precio_venta_producto.Id_Producto_Detalle = ds_tbl_producto_detalle.Id_Producto_Detalle left join ds_cat_tipo_producto on ds_cat_tipo_producto.Id_Tipo_Producto = ds_tbl_producto.Id_Tipo_Producto left join ds_cat_color on ds_cat_color.Id_Color = ds_tbl_producto_detalle.Id_Color left join ds_cat_talla on ds_cat_talla.Id_Talla = ds_tbl_producto_detalle.Id_Talla left join ds_tbl_inventario_evento on ds_tbl_inventario_evento.Id_Producto_Detalle = ds_tbl_producto_detalle.Id_Producto_Detalle left join ds_tbl_costo_compra_producto on ds_tbl_costo_compra_producto.Id_Producto_Detalle = ds_tbl_producto_detalle.Id_Producto_Detalle left join ds_tbl_cantidad_minima_producto on ds_tbl_cantidad_minima_producto.Id_Producto_Detalle = ds_tbl_producto_detalle.Id_Producto_Detalle left join ds_cat_categoria_producto on ds_cat_categoria_producto.Id_Categoria_Producto = ds_tbl_producto.Id_Categoria_Producto $where_append group by ds_tbl_producto_detalle.Id_Producto_Detalle order by $tbl_main.Descripcion asc";
        //
    }
