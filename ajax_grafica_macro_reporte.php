    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
			['Mes' <?php foreach($marcas_graph as $marca_val){ ?>, 'Ventas: <?php echo $marca_val->Descripcion; ?>', 'Cantidades vendidas: <?php echo $marca_val->Descripcion; ?>' <?php } ?>],
          <?php $inc_mes = 0; ?>
