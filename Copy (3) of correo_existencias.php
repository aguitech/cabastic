...
// Email subject
$mail->Subject = 'Actualizaci&oacute;n de existencias';

// Set email format to HTML
$mail->isHTML(true);

// Email body content
$mailContent = "<h1>Actualizaci&oacute;n de existencias</h1>
...
$mailContent .= " actualizo el producto:<br />";
$mailContent .= $producto_val->Nombre . "<br /><br />";
$mailContent .= "Cambiaron de {$existencias_actual} a {$existencias_nuevas}:<br />";
