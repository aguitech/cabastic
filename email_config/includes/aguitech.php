...
function compartir_con_redes($url, $titulo){
	...
	'<div style="padding:3px 0;">
		...
		<a href="javascript:agregar_favorito(\'' . $url . '\', \'' . $titulo . '\');" title="Agregar a favoritos">
			<img src="http://chokococo.com/images/redes/favorito.gif" alt="Agregar a favoritos" border="0">
		</a>
