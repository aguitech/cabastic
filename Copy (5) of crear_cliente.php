...
*/ ?>
            ...
            <div class="form-row">
            	<div class="form-group col-md-6">
    				...
    				<input type="text" placeholder="Limite_Credito" name="Limite_Credito" id="Limite_Credito" value="<?php echo $resultado->Limite_Credito; ?>"  class="form-control" />
            	</div>
            	<div class="form-group col-md-6">
                
             		<div>Plazo de Cr&eacute;dito</div>
    				<input type="text" placeholder="Plazo_Credito" name="Plazo_Credito" id="Plazo_Credito" value="<?php echo $resultado->Plazo_Credito; ?>"  class="form-control" />
            	</div>
            </div>
            ...
            <div class="form-row">
            	<div class="form-group col-md-12">
                	<?php foreach($datos_envios as $datos_envio): ?>
             		<div><a onclick="obtener_direccion_envio(<?php echo $datos_envio->Id_Cliente_Domicilio_Entrega; ?>);">Editar</a><?php //print_r($datos_envio); ?><?php echo $datos_envio->Calle . " " . $datos_envio->Colonia; ?></div>
             		<?php endforeach; ?>
            	</div>
            </div>
            <div class="form-row">
