						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Layouts">
								...
								<div style="display:none;" id="submenu_productos">
									<li class="nav-item"><a href="productos.php" class="nav-link active"> &bull; Listado</a></li>
									<li class="nav-item"><a href="asignar_precio_venta.php" class="nav-link active"> &bull; Asignar Precio Venta</a></li>
									<li class="nav-item"><a href="asignar_costo_venta.php" class="nav-link active"> &bull; Asignar Costo Venta</a></li>
								</div>
