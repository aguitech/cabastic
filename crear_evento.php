    ...
    <h3><?php if($_POST["id"] != ""): echo "Actualizar"; else: echo "Crear"; endif; ?> evento</h3>
			...
			<div class="form-row">
                <div class="form-group col-md-6">
                 	<div class="subtitle_form">Nombre Evento</div>
                 	...
                 	<div class="form-group">
									...
									*/ ?>
									<div class="input-group">
										...
										<input type="text" min="<?php echo date("Y-m-d"); ?>" class="form-control daterange-single" value="<?php echo $resultado->Fecha_Inicio; ?>" name="Fecha_Inicio" id="Fecha_Inicio">
									</div>
            ...
            <div class="form-row">
                 	...
                 	<div class="form-group">
									...
									*/ ?>
									<div class="input-group">
										...
										<input type="text" class="form-control daterange-single" value="<?php echo $resultado->Fecha_Cierre; ?>"  name="Fecha_Cierre" id="Fecha_Cierre">
									</div>
            	...
            	<div class="form-group col-md-6">
             		...
             		<div class="subtitle_form">Calle</div>
