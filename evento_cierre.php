					...
					<table class="table datatable-basic">
						...
						<?php foreach($resultados as $resultado): ?>
							...
							<tr id="element<?php echo $id_resultado; ?>">
								...
								$id_producto_detalle = $resultado->Id_Producto_Detalle;
								
								$qry_producto_detalle = "select * from ds_tbl_inventario_almacen where Id_Produto_Detalle = $id_producto_detalle";
								
								
								$inventario_almacen = $obj->get_row($qry_producto_detalle);
								
								$id_inventario = $inventario_almacen->Id_Inventario;
								
								$nuevo_inventario_almacen = $inventario_almacen->Cantidad_Inventario + $resultado->Cantidad;
								
								
								$qry_regresar_inventario = "update ds_tbl_inventario_almacen set Cantidad_Inventario = $nuevo_inventario_almacen where Id_Inventario = $id_inventario";
								
								$obj->query($qry_regresar_inventario);
								
								
								
								
								
								$qry_limpiar_inventario_evento = "update ds_tbl_inventario_evento set Cantidad = 0 where Id_Inventario_Evento = $id_resultado";
								
								$obj->query($qry_limpiar_inventario_evento);
								
								
								
								
								$qry_resultado_inventario_evento = "select * from ds_tbl_inventario_evento where Id_Producto_Detalle = $id_producto_detalle";
								$resultado_inventario_evento = $obj->get_row($qry_resultado_inventario_evento);
								
								?>
								
								
								<td><?php echo $resultado_inventario_evento->Cantidad; ?></td>
