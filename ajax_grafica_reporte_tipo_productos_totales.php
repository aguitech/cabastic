...
//$count_categoria = $obj->get_row("select count(*) as conteo from ds_cat_tipo_producto where Id_Tipo_Producto = $tipo_producto");
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Mes' <?php foreach($categorias_graph as $categorias_text){ ?>, '<?php echo $categorias_text->Descripcion; ?>'<?php } ?>],
          <?php $inc_mes = 0; ?>
        ...
        var options = {
          title: 'Reporte tipo de productos totales USD',
